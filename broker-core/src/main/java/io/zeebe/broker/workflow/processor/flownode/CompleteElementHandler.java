...
public class CompleteElementHandler<T extends ExecutableFlowNode> implements BpmnStepHandler<T> {
  @Override
  public void handle(BpmnStepContext<T> context) {
    final MappingException mappingException = applyOutputMapping(context);
  ...
  private MappingException applyOutputMapping(BpmnStepContext<T> context) {
  ...
  protected void completeActivity(BpmnStepContext<T> context) {}
}
